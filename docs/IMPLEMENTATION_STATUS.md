...
| otel_traces | CONTRACTED | SPEC.md DoD #16 |
...
| full_epistemic_graph | CONTRACTED | observation/belief schemas; store still claim/evidence seed |
| environment_compiler | CONTRACTED | contracts/schemas/*environment*; ADR-0003 |
